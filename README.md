...
- **Two weapons, one armory.** A Pulse Blaster for pressure and a Runic Charge whose cross-shaped blast breaks walls, crates and crowds. Spend scrap at the field terminal; upgrades carry to the next hold.
...
An early build: all four holds are playable end to end, three more weapon families are in development, and art and effects are still being pushed. Found a problem? [Open an issue](https://github.com/gduplessy/RansWake-Releases/issues) with your build number (shown in the release name) and what happened.
